...
PRIMATIPS_PRIMATIPS_BASE_URL = "https://primatips.com"

def scrape_league_table(league_url):
    response = requests.get(f"{PRIMATIPS_BASE_URL}/{league_url}")
...
def scrape_team_stats(team_link, type="overall"):
    if type == "overall":
        url_to_scrape = f"{PRIMATIPS_BASE_URL}{team_link}"
    if type == "home":
        url_to_scrape = f"{PRIMATIPS_BASE_URL}{team_link}/league-home"
    if type == "away":
        url_to_scrape = f"{PRIMATIPS_BASE_URL}{team_link}/league-away"
