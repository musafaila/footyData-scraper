from scrapers.footy_league_stats_scraper import scrape_leagues_stats
from scrapers.footy_league_table_scraper import scrape_tables
from scrapers.footy_teams_scraper import scrape_teams_stats
